...
scoreboard.write("PLAYER 1: {}    PLAYER 2: {}\n Speed P1: {}    Speed P2: {}".format(score_player1,score_player2,speedp1,speedp2))
while (secenek==1):
    player1.forward(speedp1)
    player2.forward(speedp2)
    if player1.xcor()>345 or player1.xcor()<-345:
        player1.right(179)
        winsound.PlaySound("sekme.wav",winsound.SND_ASYNC)
    ...
    if player1.xcor()>349 and player1.ycor()<-349:
        player1.right(179)
        winsound.PlaySound("sekme.wav",winsound.SND_ASYNC)
    if player2.ycor()>349 and player2.xcor()<-349:
        player2.right(179)
        winsound.PlaySound("sekme.wav",winsound.SND_ASYNC)
    ...
    if player2.ycor()>345 or player2.ycor()<-345:
        player2.right(179)
        winsound.PlaySound("sekme.wav",winsound.SND_ASYNC)
    if player1.ycor()>349 and player1.xcor()<-349:
        player1.right(179)
        winsound.PlaySound("sekme.wav",winsound.SND_ASYNC)
    ...
    #yeme göre pozisyon
    uzaklık1= math.hypot(player1.xcor()yemeksi.xcor() ,player1.ycor()yemeksi.ycor() )
    if uzaklık1<20:
            
            winsound.PlaySound("yemarti.wav",winsound.SND_ASYNC) 
            score_player1+=1
    ...
    uzaklık2= math.hypot(player2.xcor()yemeksi.xcor() ,player2.ycor()yemeksi.ycor() )
    if uzaklık2<20:
            winsound.PlaySound("yemarti.wav",winsound.SND_ASYNC) 
            score_player2+=1
    ...
    if uzaklık3<20:
            ...
            if(b<=1):
                winsound.PlaySound("hızlanma.wav",winsound.SND_ASYNC)
                speedp1+=0.50
            if(b>=5):
                winsound.PlaySound("yavaslama.wav",winsound.SND_ASYNC)
                speedp1-=0.30   
            if(b>1 and b<=3):
                score_player1+=2
                winsound.PlaySound("buffyem.wav",winsound.SND_ASYNC)
            if(b>3 and b<5):
                score_player1-=2
                winsound.PlaySound("debuffyem.wav",winsound.SND_ASYNC)  
            scoreboard.clear()
            scoreboard.write("PLAYER 1: {}    PLAYER 2: {}\n Speed P1: {}    Speed P2: {}".format(score_player1,score_player2,speedp1,speedp2))
            buff.setposition(random.randint(-345,345),random.randint(-345,345))
    ...
    if(score_player1>=20):
        ...
        scoreboard.pencolor("white")
        winsound.PlaySound("bitis.wav",winsound.SND_ASYNC) 
        scoreboard.write("PLAYER 1: {}    PLAYER2: {} \n  PLAYER 1 WON!".format(score_player1,score_player2))
        scoreboard.hideturtle()
...
while (secenek==2):  
    ...
    if uzaklık3<20:
            ...
            if(b>1 and b<=3):
                ...
                winsound.PlaySound("pikselarti.wav",winsound.SND_ASYNC)
            if(b>3 and b<5):
                if(boyut1>0.50):
                    boyut1-=0.25
                    player1.turtlesize(boyut1)
                    
                winsound.PlaySound("pikseleksi.wav",winsound.SND_ASYNC)   
            scoreboard.clear()
            scoreboard.write("PLAYER 1: {}    PLAYER 2: {}\n Speed P1: {}    Speed P2: {}".format(score_player1,score_player2,speedp1,speedp2))
            buff.setposition(random.randint(-345,345),random.randint(-345,345))
